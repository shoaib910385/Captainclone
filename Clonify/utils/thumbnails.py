...
def load_fonts():
    try:
        return {
            "cfont": ImageFont.truetype("Clonify/assets/cfont.ttf", 24),
            "tfont": ImageFont.truetype("Clonify/assets/font.ttf", 30),
        }
...
FALLBACK_IMAGE_PATH = "Clonify/assets/controller.png"
...
async def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    try:
        controls = Image.open("Clonify/assets/controls.png").convert("RGBA")
